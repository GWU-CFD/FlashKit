...
class SimulationData:
    ...
    def from_plot_files(cls, *, basename: str, grid: str, path: str, plot: str, step: int):
        ...
        return cls(axis=axisNumProcs, block=plotfile, boxes=bndboxes, centers=centers, grids=grids, ndim=ndim, procs=numProcs, shapes=shapes, sizes=sizes)
    ...
    def from_options(cls, *, block: Optional[str] = None, coords: Optional[Coords] = None, ndim: int, path: str, procs: tuple[int, int, int], sizes: tuple[int, int, int]):
        ...
        return cls(axis=axisNumProcs.tolist(), block=blockfile, boxes=boxes, centers=centers, grids=grids, ndim=ndim, procs=numProcs, shapes=shapes, sizes=sizes)
